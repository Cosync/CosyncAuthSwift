...
public class CosyncAuthRest {
    ...
    public var appId: String?                       // CosyncAuth app id
    ...
    public static let shared = CosyncAuthRest()
    ...
    @MainActor public func login(_ handle: String, password: String) async throws -> Void {
        ...
        guard let appToken = self.appToken else {
            throw CosyncAuthError.cosyncAuthConfiguration
        }
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.loginPath)")!
        ...
        do {
            ...
            try CosyncAuthError.checkResponse(data: data, response: response)
    ...
    // Login Complete into CosyncAuth
    @MainActor public func loginComplete(_ code: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.loginCompletePath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    @MainActor public func loginAnonymous(_ handle: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.loginAnonymousPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    @MainActor public func signup(_ handle: String, password: String, metaData: String?, locale: String? = nil) async throws -> Void {
        ...
        if self.checkPassword(password) {
            ...
            let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.signupPath)")!
            var urlRequest = URLRequest(url: url)
            urlRequest.httpMethod = "POST"
            urlRequest.allHTTPHeaderFields = ["app-token": appToken]
            ...
            throw CosyncAuthError.invalidPassword
        }

    }

    // register into CosyncAuth
    @MainActor public func register(_ handle: String, password: String, metaData: String?, code: String, locale: String? = nil)  async throws -> Void {
        ...
        if self.checkPassword(password) {
            ...
            let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.registerPath)")!
            var urlRequest = URLRequest(url: url)
            urlRequest.httpMethod = "POST"
            urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    // Complete Singup into CosyncAuth
    @MainActor public func completeSignup(_ handle: String, code: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.completeSignupPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    // Get logged in user data from CosyncAuth
    @MainActor public func getUser() async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.getUserPath)")!
    ...
    // Set the phone number for the current user from CosyncAuth
    @MainActor public func setPhone(_ phoneNumber: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setPhonePath)")!
        var urlRequest = URLRequest(url: url)
    ...
    @MainActor public func verifyPhone(_ code: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.verifyPhonePath)")!
        var urlRequest = URLRequest(url: url)
    ...
    // Set two factor phone verification for the user for CosyncAuth
    @MainActor public func setTwoFactorPhoneVerification(_ twoFactor: Bool) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setTwoFactorPhoneVerificationPath)")!
        var urlRequest = URLRequest(url: url)
    ...
    // Set two factor google verification for the user for CosyncAuth
    @MainActor public func setTwoFactorGoogleVerification(_ twoFactor: Bool) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setTwoFactorGoogleVerificationPath)")!
        var urlRequest = URLRequest(url: url)
    ...
    // Forgot Password into CosyncAuth
    @MainActor public func forgotPassword(_ handle: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.forgotPasswordPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    // Reset password into CosyncAuth
    @MainActor public func resetPassword(_ handle: String, password: String, code: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.resetPasswordPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    // Change password into CosyncAuth
    @MainActor public func changePassword(_ newPassword: String, password: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.changePasswordPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["access-token": accessToken]
    ...
    @MainActor public func getApplication() async throws -> Void {
        ...
        guard let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.getApplicationPath)") else {
            throw CosyncAuthError.internalServerError
        }
    ...
    @MainActor public func invite(_ handle: String, metaData: String?, senderUserId: String?) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.invitePath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["access-token": accessToken]
    ...
    // Delete App User Account from CosyncAuth
    @MainActor public func deleteAccount(_ handle: String?, password: String?, token:String?) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.deleteAccountPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["access-token": accessToken]
    ...
    // Set the locale for the current user from CosyncAuth
    @MainActor public func setLocale(_ locale: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setLocalePath)")!
        var urlRequest = URLRequest(url: url)
    ...
    @MainActor public func setUserMetadata(_ metaData: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setUserMetadataPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["access-token": accessToken]
    ...
    @MainActor public func setUserName(_ userName: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.setUserNamePath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["access-token": accessToken]
    ...
    // check user name available CosyncAuth
    @MainActor public func userNameAvailable(_ userName: String) async throws -> Bool {
        ...
        guard let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.userNameAvailable)?userName=\(userName)") else {
            throw CosyncAuthError.internalServerError
        }
    ...
    @MainActor public func socialLogin(_ token: String, provider: String) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.socialLoginPath)")!
        var urlRequest = URLRequest(url: url)
        urlRequest.httpMethod = "POST"
        urlRequest.allHTTPHeaderFields = ["app-token": appToken]
    ...
    // Singup into CosyncAuth with Apple
    @MainActor public func socialSignup(_ token: String, email:String, provider:String, metaData: String?, locale: String? = nil) async throws -> Void {
        ...
        let url = URL(string: "\(cosyncRestAddress)/\(CosyncAuthRest.socialSignupPath)")!
            var urlRequest = URLRequest(url: url)
            urlRequest.httpMethod = "POST"
            urlRequest.allHTTPHeaderFields = ["app-token": appToken]
